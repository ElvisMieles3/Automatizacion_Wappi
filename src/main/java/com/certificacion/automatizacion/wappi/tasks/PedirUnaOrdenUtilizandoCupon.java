...
public class PedirUnaOrdenUtilizandoCupon implements Task {
    private OrdenPedido ordenPedido;

    public PedirUnaOrdenUtilizandoCupon(OrdenPedido ordenPedido) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        String codigoCupon = BrowseTheWeb.as(actor).findBy(SolicitarCuponUserInterface.SELECCIONA_CODIGO_CUPON.getCssOrXPathSelector()).getText();
    ...
    public static PedirUnaOrdenUtilizandoCupon conDatos(OrdenPedido ordenPedido) {

        return new PedirUnaOrdenUtilizandoCupon(ordenPedido);
    }
}
